...
<div class="row">
    ...
    <div class="col-md-6">
      <p><a href="javascript:void(0)" onclick="showRoute()" class="btn btn-info btn-sm"> <span class="glyphicon glyphicon-search"></span> Tampilkan Rute </a>
          <a href="?m=detail&ID=<?=$_GET['ID']?>" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-list"></span></a></p>
        ...
        <div class="row">
            ...
            foreach($rows as $r):?>
            <div class="col-lg-10 col-md-10 col-xs-10 thumb">
...
<div class="modal fade" id="image-gallery" tabindex="10" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
